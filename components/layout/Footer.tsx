  ...
  return (
    <footer className="bg-white">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 flex items-center justify-between lg:px-8">
        <a href="https://akhilkumarportfolio.lovable.app/about">
          <span className="text-center text-sm text-gray-500 hover:text-gray-900">
            &copy; {new Date().getFullYear()} Akhil Kumar
          </span>
        </a>
        <div className="flex justify-center space-x-6 md:order-2">
          ...
          <a
            href="https://akhilkumarportfolio.lovable.app/"
